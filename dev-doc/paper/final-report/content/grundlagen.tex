...
\hline
\textbf{Approximierung} & Loop \((C^2)\) & Catmull-Clark \((C^2)\)\\
\textbf{Interpolierung} & Butterfly \((C^1)\) & Kobbelt \((C^1)\)\\
\end{tabular}
\end{table}
\begin{table}
\center
...
\input{content/grundlagen_catmull}
\input{content/grundlagen_loop}
\input{content/grundlagen_butterfly}
\input{content/grundlagen_doosabin}
